(function (_) {
    ...
    describe("Testing the units controller: ", function () {
            ...
            inject(["$rootScope", "$controller", "SERVER_URL",
                ...
                function ($rootScope, $controller, _SERVER_URL,
                    ...
                    controller = function (ctrl, params) {
                        return $controller(
                            "huqas.setup.units.controllers."+ctrl,
        ...
        it("should test edit units controller | success", function () {
            var dt = {
                $stateParams: {unit_id: 1}
            };
            var res = {msg: "ok"};
            $httpBackend.expectGET(SERVER_URL+"api/v1/catalog/units/").respond(200, res);
            controller("main",dt);
            $httpBackend.flush();
        });

        it("should test edit units controller | fail", function () {
            var dt = {
                $stateParams: {unit_id: 1}
            };
            $httpBackend.expectGET(SERVER_URL+"api/v1/catalog/units/").respond(500, {});
            controller("main",dt);
            $httpBackend.flush();
        });
        it("should test editing a unit",
            function () {
            inject(["huqas.common.forms.changes", function (formChanges) {
                ...
                controller("edit_unit", data);
                $httpBackend.expectGET(SERVER_URL +
                    "api/v1/catalog/analytes/")
                    .respond(200,{results :[]});
                $httpBackend.expectGET(SERVER_URL +
                    "api/v1/catalog/units/1/").respond(200,{results :[]});
                $httpBackend.expectGET(SERVER_URL +
                    "api/v1/catalog/unit_conversions/?unit=1")
                    .respond(200,{results :[]});
                $httpBackend.expectPATCH(SERVER_URL +
                    "api/v1/catalog/units/1/")
                    .respond(200, {"name" :"get"});
                scope.save();
                $httpBackend.flush();
            }]);
        });
        it("should test editing a unit: fail",
            function () {
            inject(["huqas.common.forms.changes", function (formChanges) {
                var data = {
                    "$stateParams" : {
                ...
                $httpBackend.expectGET(SERVER_URL +
                    ...
                    .respond(500,{});
                $httpBackend.expectGET(SERVER_URL +
                    "api/v1/catalog/units/1/").respond(500,{});
                $httpBackend.expectGET(SERVER_URL +
                    "api/v1/catalog/unit_conversions/?unit=1")
                    .respond(500,{});
                $httpBackend.expectPATCH(SERVER_URL +
        ...
        it("should test creating a unit : success",
            function () {
            inject(["huqas.common.forms.changes", function (formChanges) {
                var data = {
                    "$stateParams" : {
        ...
        it("should test creating a unit: fail",
            function () {
            inject(["huqas.common.forms.changes", function (formChanges) {
                var data = {
                    "$stateParams" : {
        ...
        it("should test creating an unit",
            function () {
            inject(["huqas.common.forms.changes", function (formChanges) {
                var data = {
                    "$stateParams" : {
